	...
	public void createComponents()
	{
		...
		submit.addActionListener(new ActionListener() {			
			public void actionPerformed(ActionEvent arg0) {
				...
				{
				    JOptionPane.showMessageDialog(null, "Gender can't be null!", "Error",
				                                    JOptionPane.ERROR_MESSAGE);
				}
				...
				Employee employee = new Employee(fNameBox.getText(), lNameBox.getText(), phoneBox.getText(), departmentBox.getText(), titleList.getSelectedItem().toString(), selectedGender );
